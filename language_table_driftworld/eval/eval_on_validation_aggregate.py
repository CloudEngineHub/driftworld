"""
Aggregator for evaluating visual quality metrics on the Language Table validation set.
...
def aggregate(cfg, step, world_size, *,
...
def _build_parser():
    p = argparse.ArgumentParser(description="Multi-GPU eval -- aggregate + FID + FVD")
